  ...
  resources: {
    uz: {
      translation: {
        ...
        marketingDes:
          "Istalgan qiyinchilikdagi mobil ilovalarni ishlab chiqish va ularni texnik qo’llab quvvatlash",
        carusel_card_description: "Bu soha bo’yicha batafsil ma’lumotni bilib oling.Videoni tomosha qiling",
        ...
        card_text_1: "Bizning IT xizmatlarimiz foydalanish uchun oddiy va qulay",
        card_text_2: "Kompaniyamiz doimiy ravishda xizmat sifatini oshirishga intilamiz",
        card_text_3: "Mijozlarni IT muammolari bo‘yicha yuqori saviyaga ega texnik yordam bermoqdamiz",
        card_text_4:"Mijozlarimizga eng yaxshi va tezkor yordam bermoqdamiz",
        card_text_5:"Texnologiyalar sohasida biz innovatsion yondashuvlarni amalga oshiramiz",
        card_text_6:"Biz IT muammolari uchun operativ yechimlarni taqdim etamiz",
    ...
    en: {
      translation: {
        ...
        marketingDes:
          "Development of mobile applications of any complexity and their technical support",
        carusel_card_description: "Learn more about this industry. Watch the video.",
        ...
        card_text_2: "Our company strives to constantly improve the quality of service",
        card_text_3: "We provide our clients with high-quality technical support for IT problems.",
        card_text_4:"We provide the best and fastest support to our customers",
        card_text_5:"We implement innovative approaches in the field of technology",
    ...
    ru: {
      translation: {
        ...
        targetingDes:
          "Техники создания программного обеспечения для компьютеров или мобильных устройств и его использования",
        carusel_card_description: "Узнайте больше об этой отрасли. Посмотрите видео.",
        ...
        card_text_2: "Наша компания стремится постоянно улучшать качество обслуживания.",
        card_text_3: "Мы оказываем нашим клиентам качественную техническую поддержку по решению ИТ-проблем.",
